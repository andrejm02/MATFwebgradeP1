//Definisati strukturu SAH koja sadrzi tri polja: figura (niska duzine najvise 10 karaktera), red (ceo broj iz opsega [1, 8]) i kolona 
//(karakter - malo slovo od 'a' do 'h'). Napisati funkciju int napada(SAH *f1, SAH *f2) koja vraca 1, ako f1 napada f2, u suprotnom vraca 0. 
